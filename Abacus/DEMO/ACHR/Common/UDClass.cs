...
namespace ACHR
{
    ...
    public class UDClass
    {
            ...
            try
            {
              ...
              oCompany = (SAPbobsCOM.Company) oApplication.Company.GetDICompany();
                if (ret2 == 0)
                {
                    ...
                    frmList = new List<string> { "672","149"};
        ...
        public void createConfigurationTables()
        {
            ...
            AddTable("B1_PARAM1", "Parameter1", BoUTBTableType.bott_NoObject);
            AddTable("B1_PARAM2", "Parameter2", BoUTBTableType.bott_NoObject);
            AddTable("B1_PARAM3", "Parameter3", BoUTBTableType.bott_NoObject);
            AddTable("B1_PARAM4", "Parameter4", BoUTBTableType.bott_NoObject);
            AddTable("B1_PARAM5", "Parameter5", BoUTBTableType.bott_NoObject);
            AddTable("B1_PARAM6", "Parameter6", BoUTBTableType.bott_NoObject);
            AddTable("B1_PARAM7", "Parameter7", BoUTBTableType.bott_NoObject);
            AddTable("B1_PARAM8", "Parameter8", BoUTBTableType.bott_NoObject);

            AddColumns("OITM", "PARAM1", "PARAM1", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM1");
            AddColumns("OITM", "PARAM2", "PARAM2", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM2");
            AddColumns("OITM", "PARAM3", "PARAM3", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM3");
            AddColumns("OITM", "PARAM4", "PARAM4", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM4");
            AddColumns("OITM", "PARAM5", "PARAM5", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM5");
            AddColumns("OITM", "PARAM6", "PARAM6", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM6");
            AddColumns("OITM", "PARAM7", "PARAM7", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM7");
            AddColumns("OITM", "PARAM8", "PARAM8", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "B1_PARAM8");


            string[,] PC = new string[2, 2] {{"01","START"},{"02","STOP"} };
            AddColumns("OWOR", "ST", "Start/Stop", SAPbobsCOM.BoFieldTypes.db_Alpha, 02, SAPbobsCOM.BoFldSubTypes.st_None, "",PC);
          

            AddTable("B1_SETTING", "Setting", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_SETTING", "Value", "Setting", SAPbobsCOM.BoFieldTypes.db_Alpha, 254, SAPbobsCOM.BoFldSubTypes.st_None);

            AddColumns("OITM", "Picture", "Picture", SAPbobsCOM.BoFieldTypes.db_Alpha, 254, SAPbobsCOM.BoFldSubTypes.st_Image);
