...
namespace ACHR
{
    ...
    public class UDClass
    {
            ...
            try
            {
              ...
              oCompany = (SAPbobsCOM.Company) oApplication.Company.GetDICompany();
                if (ret2 == 0)
                {
                    ...
                    frmList = new List<string> { "mnu_NC" };
                    ...
                    if (File.Exists("Notes_Row.txt")) addNotesRow();
                    if (File.Exists("Notes_Col.txt")) addNotesCol();
        
                    if (File.Exists("Notes_Head.txt")) addNotesHead();
                    if (File.Exists("Notes_GL.txt")) addGL();
        ...
        private void addNotesRow()
        {
            ...
            string filePath = @"Notes_Row.txt";
            using (StreamReader file = new StreamReader(filePath))
            {
                oApplication.MessageBox("Reading File");
                string line = "";
                string[] pastrts;
            ...
            //        oApplication.MessageBox(colName);
                }
                while ("a" == "a")
                {
                    line = file.ReadLine();
            ...
            System.IO.File.Move("Notes_Row.txt", "Notes_Row_DONE.txt");
           
            foreach (DataRow dr in dt.Rows)
            {
                string Code = dr["Code"].ToString().Replace("'", "''");
                string Name = dr["Name"].ToString().Replace("'", "''");
                string U_Title = dr[3].ToString().Replace("'", "''");
                string U_Position = dr[4].ToString().Replace("'", "''");
                string U_TitleOnly = dr[5].ToString().Replace("'", "''");
                string U_Note = dr[6].ToString().Replace("'", "''");

                string QryStr = " INSERT INTO \"@AC_RPT_NR\"(\"Code\",\"Name\",\"U_Title\",\"U_Position\",\"U_TitleOnly\",\"U_Note\") VALUES('" + Code + "','" + Name + "','" + U_Title + "','" + U_Position + "','" + U_TitleOnly + "','" + U_Note + "')";

                    ExecQuerySilent(QryStr,"Adding Notes");
        ...
        private void addNotesCol()
        {

            System.Data.DataTable dt = new System.Data.DataTable();
            string filePath = @"Notes_Col.txt";
            using (StreamReader file = new StreamReader(filePath))
            {
                oApplication.MessageBox("Reading File");
                string line = "";
            ...
            System.IO.File.Move("Notes_Col.txt", "Notes_Col_DONE.txt");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                string U_Title = dr[3].ToString().Replace("'", "''");
                string U_Position = dr[4].ToString().Replace("'", "''");
                string U_Note = dr[5].ToString().Replace("'", "''");

                string QryStr = " INSERT INTO \"@AC_RPT_NC\"(\"Code\",\"Name\",\"U_Title\",\"U_Position\",\"U_Note\") VALUES('" + Code + "','" + Name + "','" + U_Title + "','" + U_Position + "','" + U_Note + "')";

                ExecQuerySilent(QryStr, "Adding NotesCol");

            }

        }

        private void addNotesHead()
        {

            System.Data.DataTable dt = new System.Data.DataTable();
            try
            {
                string filePath = @"Notes_Head.txt";
                using (StreamReader file = new StreamReader(filePath))
                {
                    oApplication.MessageBox("Reading File");
                    string line = "";
                ...
                System.IO.File.Move("Notes_Head.txt", "Notes_Head_DONE.txt");
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string U_Title = dr[3].ToString().Replace("'","''");
                    string U_Position = dr[4].ToString().Replace("'", "''");
                    string U_NoteOf = dr[5].ToString().Replace("'", "''");
                    string U_Group1 = dr[6].ToString().Replace("'", "''");
                    string U_Group2 = dr[7].ToString().Replace("'", "''");
                    string U_Group3 = dr[8].ToString().Replace("'", "''");

                    string QryStr = " INSERT INTO \"@AC_RPT_NOTE\"(\"Code\",\"Name\",\"U_Title\",\"U_Position\",\"U_NoteOf\",\"U_Group1\",\"U_Group2\",\"U_Group3\") VALUES('" + Code + "','" + Name + "','" + U_Title + "','" + U_Position + "','" + U_NoteOf + "','" + U_Group1 + "','" + U_Group2 + "','" + U_Group3 + "')";

                    ExecQuerySilent(QryStr, "Adding Notes Head");
        ...
        private void addGL()
        {
            ...
            try
            {
                ...
                System.IO.File.Move("Notes_GL.txt", "Notes_GL_DONE.txt");

                if (dt.Rows.Count > 0)
                {
                    string QryStr = " DELETE FROM \"@AC_RPT_NGL\"";

                    ExecQuery(QryStr, "Deleting GL");
                }
                foreach (DataRow dr in dt.Rows)
                {
                    string Code = dr["Code"].ToString();
                    string Name = dr["Name"].ToString();
                    string U_Row = dr[3].ToString();
                    string U_Col = dr[4].ToString();
                    string U_GL = dr[5].ToString();
                    string U_ValType = dr[6].ToString();

                    string QryStr = " INSERT INTO \"@AC_RPT_NGL\"(\"Code\",\"Name\",\"U_Row\",\"U_Col\",\"U_GL\",\"U_ValType\") VALUES('" + Code + "','" + Name + "','" + U_Row + "','" + U_Col + "','" + U_GL + "','" + U_ValType + "')";

                    ExecQuery(QryStr, "Adding Notes GL");
        ...
        public void createConfigurationTables()
        {
            ...
            AddTable("AC_RPT_NOTE", "Financial Statemet Notes", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_AM", "AcctCode", "Account Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_AM", "AcctLevel", "Account Level", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
           
            AddColumns("@B1_AM", "Title", "Note Title", SAPbobsCOM.BoFieldTypes.db_Alpha, 200);
            AddColumns("@B1_AM", "Position", "Note Position", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@B1_AM", "NoteOf", "Notes Of", SAPbobsCOM.BoFieldTypes.db_Alpha, 2);


            AddTable("AC_RPT_CON", "Financial Statemet Configuration", BoUTBTableType.bott_NoObject);
            AddColumns("@AC_RPT_CON", "BalPrDT1", "Balance Sheed Period Date 1", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "BalPrDT2", "Balance Sheed Period Date 2", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "BalPrDT3", "Balance Sheed Period Date 3", SAPbobsCOM.BoFieldTypes.db_Date);

            AddColumns("@AC_RPT_CON", "PNLR1DTF", "PNL 1st Range from Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "PNLR1DTT", "PNL 1st Range to Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "PNLR2DTF", "PNL 2nd Range from Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "PNLR2DTT", "PNL 2nd Range to Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "PNLR3DTF", "PNL 3rd Range from Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "PNLR3DTT", "PNL 3rd Range to Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "PNLR4DTF", "PNL 4th Range from Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "PNLR4DTT", "PNL 4th Range to Date", SAPbobsCOM.BoFieldTypes.db_Date);

            AddColumns("@AC_RPT_CON", "CFR1DTF", "Cash Flow 1st Range from Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "CFR1DTT", "Cash Flow 1st Range to Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "CFR2DTF", "Cash Flow 2nd Range from Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_CON", "CFR2DTT", "Cash Flow 2nd Range to Date", SAPbobsCOM.BoFieldTypes.db_Date);
           
            */

            AddTable("AC_RPT_NOTE", "Financial Statemet Notes", BoUTBTableType.bott_NoObject);

            AddColumns("@AC_RPT_NOTE", "Title", "Note Title", SAPbobsCOM.BoFieldTypes.db_Alpha, 200);
            AddColumns("@AC_RPT_NOTE", "Position", "Note Position", SAPbobsCOM.BoFieldTypes.db_Numeric, 8);
            AddColumns("@AC_RPT_NOTE", "NoteOf", "Notes Of", SAPbobsCOM.BoFieldTypes.db_Alpha, 8);
            AddColumns("@AC_RPT_NOTE", "Group1", "Group1", SAPbobsCOM.BoFieldTypes.db_Alpha, 100);
            AddColumns("@AC_RPT_NOTE", "Group2", "Group2", SAPbobsCOM.BoFieldTypes.db_Alpha, 100);
            AddColumns("@AC_RPT_NOTE", "Group3", "Group3", SAPbobsCOM.BoFieldTypes.db_Alpha, 100);


            AddTable("AC_RPT_NR", "Financial Statemet Notes Row", BoUTBTableType.bott_NoObject);
            AddColumns("@AC_RPT_NR", "Title", "Note Title", SAPbobsCOM.BoFieldTypes.db_Alpha, 200);
            AddColumns("@AC_RPT_NR", "Position", "Note Position", SAPbobsCOM.BoFieldTypes.db_Numeric, 8);
            AddColumns("@AC_RPT_NR", "TitleOnly", "Title Only", SAPbobsCOM.BoFieldTypes.db_Alpha, 1);
            AddColumns("@AC_RPT_NR", "Note", "Note Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@AC_RPT_NR", "ValOf", "Value Of", SAPbobsCOM.BoFieldTypes.db_Alpha, 2);
            AddColumns("@AC_RPT_NR", "From", "From", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@AC_RPT_NR", "To", "To", SAPbobsCOM.BoFieldTypes.db_Date);



            AddTable("AC_RPT_NC", "Financial Statemet Notes Col", BoUTBTableType.bott_NoObject);
            AddColumns("@AC_RPT_NC", "Title", "Note Title", SAPbobsCOM.BoFieldTypes.db_Alpha, 200);
            AddColumns("@AC_RPT_NC", "Position", "Note Position", SAPbobsCOM.BoFieldTypes.db_Numeric, 8);
            AddColumns("@AC_RPT_NC", "Note", "Note Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);


            AddTable("AC_RPT_NGL", "Financial Statemet - Acct", BoUTBTableType.bott_NoObject);
            AddColumns("@AC_RPT_NGL", "Row", "Row", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@AC_RPT_NGL", "Col", "Col", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@AC_RPT_NGL", "GL", "GL", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@AC_RPT_NGL", "ValType", "Value Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@AC_RPT_NGL", "HCDate", "HC Date", SAPbobsCOM.BoFieldTypes.db_Date, 30);
            AddColumns("@AC_RPT_NGL", "PC", "Cost/Profit Center", SAPbobsCOM.BoFieldTypes.db_Alpha, 50);
            AddColumns("@AC_RPT_NGL", "PRJ", "Project ID", SAPbobsCOM.BoFieldTypes.db_Alpha, 50);
        ...
        private void loadMenu(string lang)
        {
            ...
            if (mnus.Exists("mnu_NC"))
            {
                mnus.RemoveEx("mnu_NC");
            }

            mnus.Item("9728").SubMenus.Add("mnu_NC", "Notes Configuration", BoMenuType.mt_STRING, 2);
