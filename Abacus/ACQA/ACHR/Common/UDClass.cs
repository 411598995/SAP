...
namespace ACHR
{
    ...
    public class UDClass
    {
            ...
            try
            {
              ...
              oCompany = (SAPbobsCOM.Company) oApplication.Company.GetDICompany();
                if (ret2 == 0)
                {
                    ...
                    frmList = new List<string> { "mnu_Attr", "mnu_AS", "mnu_INSP","mnu_ADM" };
                    frmList.Add("65211");

                    UDOList = new List<string> { "B1_QA_ATTR_INSWHS","B1_QA_OBJS" };
        ...
        public void createConfigurationTables()
        {
            ...
            AddTable("B1_QA_ATTR", "QA Attribute Master", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_QA_ATTR", "Descr", "Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "Type", "Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "DefVal", "Default Value", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "LOVT", "LOV Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "LOVSQL", "SQL", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "DefValRem", "Validity Remarks", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "CreateDT", "Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "UpdateDT", "Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "VisOrder", "VisOrder", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR", "Active", "Active", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None);


            AddTable("B1_QA_ATTR_LOV", "QA Attribute LOV", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_QA_ATTR_LOV", "Val", "Value", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR_LOV", "Descr", "Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR_LOV", "VisOrder", "VisOrder", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR_LOV", "AttrCode", "Attribute Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);



            AddTable("B1_QA_ATTR_OWHS", "Ware Houses", BoUTBTableType.bott_NoObject);

            AddTable("B1_QA_ATTR_INSWHS", "Inspection Ware Houses", BoUTBTableType.bott_NoObjectAutoIncrement);
            AddColumns("@B1_QA_ATTR_INSWHS", "OWHS", "Attached Warehouse", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None, "B1_QA_ATTR_OWHS");
            AddColumns("@B1_QA_ATTR_INSWHS", "OWHS_APPR", "Approved Warehouse", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None, "B1_QA_ATTR_OWHS");
            AddColumns("@B1_QA_ATTR_INSWHS", "OWHS_REJ", "Rejected Warehouse", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None, "B1_QA_ATTR_OWHS");

            AddTable("B1_QA_ATTR_CODES", "QA Attributes Associated Codes", BoUTBTableType.bott_NoObjectAutoIncrement);
            AddColumns("@B1_QA_ATTR_CODES", "Descr", "Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_ATTR_CODES", "CodeType", "Code Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 10, SAPbobsCOM.BoFldSubTypes.st_None);


            AddTable("B1_QA_CODES_ATTR", "QA Attributes Associated Codes", BoUTBTableType.bott_NoObjectAutoIncrement);
            AddColumns("@B1_QA_CODES_ATTR", "Descr", "Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_CODES_ATTR", "IGCode", "Item/Group Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);


            AddTable("B1_QA_OBJS", "Inspection Object Types", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_QA_OBJS", "TblScm", "Table Scheme", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);



            AddTable("B1_QA_RPT", "Inspection Report Header", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_QA_RPT", "DocType", "Document Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT", "DocEntry", "Document Entry", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT", "ItemCode", "Item Code", SAPbobsCOM.BoFieldTypes.db_Alpha,50, SAPbobsCOM.BoFldSubTypes.st_None);

            AddColumns("@B1_QA_RPT", "LineNum", "Line Number", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT", "Batch", "Batch Number", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT", "Serial", "Serial Number", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT", "UserId", "User Id", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT", "Date", "Create Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@B1_QA_RPT", "Qty", "Total Qty", SAPbobsCOM.BoFieldTypes.db_Float,8,BoFldSubTypes.st_Quantity);
            AddColumns("@B1_QA_RPT", "ApprQty", "Approved Qty", SAPbobsCOM.BoFieldTypes.db_Float, 8, BoFldSubTypes.st_Quantity);
            AddColumns("@B1_QA_RPT", "RejQty", "Rejected Qty", SAPbobsCOM.BoFieldTypes.db_Float, 8, BoFldSubTypes.st_Quantity);
           
            AddColumns("@B1_QA_RPT", "Attachment", "Attachment", SAPbobsCOM.BoFieldTypes.db_Memo, 200, BoFldSubTypes.st_Link);

            AddTable("B1_QA_RPT_DET", "Inspection Report Detail", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_QA_RPT_DET", "HeadCode", "Report Header Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT_DET", "AttrCode", "Attribute Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_RPT_DET", "SelVal", "SelValue", SAPbobsCOM.BoFieldTypes.db_Memo, 50, SAPbobsCOM.BoFldSubTypes.st_None);

            AddTable("B1_QA_DOC", "QA Document Inspacted", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_QA_DOC", "ObjType", "Object Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_DOC", "DocEntry", "DocEntry", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_DOC", "Date", "Inspection Completed Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@B1_QA_DOC", "WTRentry", "Transfer Entry", SAPbobsCOM.BoFieldTypes.db_Numeric,8);
            AddColumns("@B1_QA_DOC", "Final", "Finallized", SAPbobsCOM.BoFieldTypes.db_Alpha, 1);
            AddColumns("@B1_QA_DOC", "Att", "Attachment", SAPbobsCOM.BoFieldTypes.db_Memo);

            AddTable("B1_QA_OUSR", "QA Users", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_QA_OUSR", "PWHS", "Production Inspection WHS", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);

            AddTable("B1_QA_OUSR_OT", "QA Users Object Types", BoUTBTableType.bott_NoObjectAutoIncrement);
            AddColumns("@B1_QA_OUSR_OT", "ObjType", "Object Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_OUSR_OT", "UsrCode", "User Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);

            AddTable("B1_QA_OUSR_WHS", "QA Users Warehouses", BoUTBTableType.bott_NoObjectAutoIncrement);
            AddColumns("@B1_QA_OUSR_WHS", "WHS", "Warehouse", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_QA_OUSR_WHS", "UsrCode", "User Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);

            AddColumns("OWOR", "B1_QA_INSGR", "Inspection Goods Receiving Number", SAPbobsCOM.BoFieldTypes.db_Numeric, 8);
            AddColumns("OWOR", "B1_QA_INSGI", "Inspection Goods Issue Number", SAPbobsCOM.BoFieldTypes.db_Numeric, 8);

            AddColumns("OWOR", "B1_QA_INSBSN", "Batch/Serial Num Prefix", SAPbobsCOM.BoFieldTypes.db_Alpha, 50,BoFldSubTypes.st_None);
            AddColumns("OWOR", "B1_QA_INSBSNST", "Batch/Serial Num From", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, BoFldSubTypes.st_None);

            AddColumns("OIGN", "B1_QA_INSP_PN", "Inspection for PO#", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, BoFldSubTypes.st_None);

            AddColumns("OWTR", "B1_QA_INSP_OT", "Inspection for Doc Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, BoFldSubTypes.st_None);
            AddColumns("OWTR", "B1_QA_INSP_DE", "Inspection for Doc Entry", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, BoFldSubTypes.st_None);


            ExecQuery("INSERT INTO \"@B1_QA_ATTR_OWHS\" SELECT T0.\"WhsCode\", T0.\"WhsName\" FROM OWHS T0 WHERE T0.\"WhsCode\" NOT IN (SELECT T1.\"Code\" FROM \"@B1_QA_ATTR_OWHS\" T1)", "Initial Warehouse");
        ...
        private void loadMenu(string lang)
        {
            ...
            mnus.Item("B1_CA").SubMenus.Add("B1_QA_ATTR_INSWHS", "QA Inspection Warehouses", BoMenuType.mt_STRING, 1);
            mnus.Item("B1_CA").SubMenus.Add("B1_QA_OBJS", "Inspection Document Types", BoMenuType.mt_STRING, 2);
            mnus.Item("B1_CA").SubMenus.Add("mnu_ADM", "User Setup", BoMenuType.mt_STRING, 3);

            mnus.Item("B1_CA").SubMenus.Add("mnu_Attr", "QA Attribute Master", BoMenuType.mt_STRING, 4);

            mnus.Item("B1_CA").SubMenus.Add("mnu_AS", "QA Attribute Association", BoMenuType.mt_STRING, 5);
            mnus.Item("B1_CA").SubMenus.Add("mnu_INSP", "QA Inspection", BoMenuType.mt_STRING,6);
        ...
        public string ExecQuery(string sql, string CallerRef,int qryType)
        {
        ...
        public string getQryString(string QryName, Hashtable pms)
        {
            ...
            System.Data.DataTable dtQry = getDataTable("SELECT * FROM \"@B1_QRY\" T0 WHERE T0.\"Name\" = '" + QryName + "'", "Geting SQL");
        ...
        public System.Data.DataTable getDataTableQryCode(string qryCode, Hashtable pms, string CallerRef)
        {
            string sql = getQryString(qryCode, pms);
        ...
        public string getScallerValueQryCode(string qryCode, Hashtable pms)
        {
            string sql = getQryString(qryCode, pms);

            string strResult = "";
            System.Data.DataTable dtScaller = getDataTable(sql, "GetScaller of UDClass");
        ...
        public long getMaxId(string tblName, string idCol)
        {
            ...
            {
                strSql = " SELECT IFNULL(MAX(CAST(\"" + idCol + "\" AS integer)), 0) AS \"nextId\" FROM \"" + tblName + "\";";
            }
            try
            {
                ...
                if (TableName.StartsWith("@") == true)
                {
                    if (!ColumnExists(TableName, Name))
                    {
                        ...
                        if (v_RetVal != 0)
                        {
                            ...
                            oApplication.StatusBar.SetText("Failed to add UserField " + Name + " - " + v_ErrCode + " " + v_ErrMsg, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
                            return false;
                        }
                        else
                        {
                            oApplication.StatusBar.SetText("[@" + TableName + "] - " + Name + " added successfully!!!", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
                            outResult = true;
                            return true;
                        }
                ...
                if (TableName.StartsWith("@") == false)
                {
                   if (!ColumnExists(TableName, Name))
                    
                    {
                        ...
                        if (!string.IsNullOrEmpty(LinkedTable))
                        {
                            if(LinkedTable.Contains("_SYS"))
                            {
                                string sysObj = LinkedTable.Replace("_SYS", "");
                               // v_UserField.LinkedSystemObject = (UDFLinkedSystemObjectTypesEnum)(Convert.ToInt16(sysObj));
                            }
                            else
                            {
                                v_UserField.LinkedTable = LinkedTable;
        ...
        public string getFileName(string filter)
        {
            ...
            using (ACHR.Common.GetFileNameClass oGetFileName = new ACHR.Common.GetFileNameClass())
            {
                ...
                oGetFileName.InitialDirectory = path;
        ...
        public string addAttacment(string filterString)
        {

            string strFileName = getFileName(filterString);
            ...
            else
            {
                ...
                strFileName = oCompany.AttachMentPath.ToString() + sFile + "." + sExt;
        ...
        public  void splitPath(string path, out string file, out string ext, out string folder)
        {
            file = "";
            ext = "";
            folder = "";
