...
namespace ACHR
{
    ...
    public class UDClass
    {
        ...
        public string getAcctName(string strAcctCode)
        {
            ...
            oRecSet.DoQuery("select acctname from oact where oact.acctcode='" + strAcctCode + "' or formatcode = '" + strAcctCode + "'");
            if (oRecSet.EoF)
            {
                strOut = "Not Found";
                return strOut;
        ...
        public string getAcctSys(string strAcctCode)
        {
            ...
            oRecSet.DoQuery("select acctcode from oact where oact.acctcode='" + strAcctCode + "' or formatcode = '" + strAcctCode + "'");
            if (oRecSet.EoF)
            {
                strOut = "Not Found";
                return strOut;
