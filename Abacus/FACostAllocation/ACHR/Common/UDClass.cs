...
namespace ACHR
{
    ...
    public class UDClass
    {
            ...
            try
            {
              ...
              oCompany = (SAPbobsCOM.Company) oApplication.Company.GetDICompany();
                if (ret2 == 0)
                {
                    ...
                    frmList = new List<string> { "mnu_AM", "mnu_AR","141","181","mnu_DBOQ","mnu_IBOQ" };
        ...
        public void createConfigurationTables()
        {
            ...
            AddTable("B1_QRY", "B1 Queries", BoUTBTableType.bott_MasterData);
            AddColumns("@B1_QRY", "QryStr", "Query String", SAPbobsCOM.BoFieldTypes.db_Memo);
            //if (!UDOExists("oB1_QRY"))
            //{
            //    String[,] findAliasNDescription = new String[,] { { "Code", "Code" }, { "Name", "Name" } };
            //    registerUDO("oB1_QRY", "B1 Queries", SAPbobsCOM.BoUDOObjType.boud_MasterData, findAliasNDescription, "B1_QRY");
            //    findAliasNDescription = null;

            //}
            AddTable("B1_AM", "Allocation Master", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_AM", "Father", "Father Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_AM", "AcctCode", "Account", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@B1_AM", "FaCode", "FA Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30);
            AddColumns("@B1_AM", "AlcBsUnt", "Base Unit", SAPbobsCOM.BoFieldTypes.db_Alpha, 2);

            AddTable("B1_AM_F", "Allocation Master Formated", BoUTBTableType.bott_NoObject);
            AddTable("B1_AM_O", "Allocation Master Object", BoUTBTableType.bott_MasterData);
          

            AddColumns("@B1_AM", "Size", "Size", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Quantity);
            AddColumns("@B1_AM", "Area", "Area", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Quantity);
            AddColumns("@B1_AM", "Volume", "Volume", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Quantity);
            AddColumns("@B1_AM", "Floors", "Floors", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Quantity);
            AddColumns("@B1_AM", "LstUpdate", "Last Updated", SAPbobsCOM.BoFieldTypes.db_Date);




            AddTable("B1_AR", "Allocation Rule", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_AR", "Active", "Active", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_AR", "BU", "BU", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_AR", "LstUpdate", "Last Updated", SAPbobsCOM.BoFieldTypes.db_Date);


            AddTable("B1_ARD", "Allocation Rule Detail", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_ARD", "RuleCode", "Rule Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_ARD", "CMC", "Cost Master Code ", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_ARD", "AP", "Allocation %", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Sum);
            AddColumns("@B1_ARD", "AddBy", "Added By Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);



            AddTable("B1_KEYVAL", "B1_Config", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_KEYVAL", "Key", "Key", SAPbobsCOM.BoFieldTypes.db_Alpha, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_KEYVAL", "Val", "Value", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);



            AddColumns("PCH1", "CostCode", "FA Cost Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("PCH1", "AlocJe", "Allocation JE", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("PCH1", "AlocJeRev", "Allocation JE Rversal", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);


            AddTable("B1_IBOQ", "Indirect BOQ", BoUTBTableType.bott_MasterData);
            AddColumns("@B1_IBOQ", "Remarks", "Remarks", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_IBOQ", "AR", "Allcation Rule", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_IBOQ", "LstUpdate", "Last Updated", SAPbobsCOM.BoFieldTypes.db_Date);

            if (!UDOExists("oIBOQ"))
            {
                String[,] findAliasNDescription = new String[,] { { "Code", "Code" }, { "Name", "Name" } };
                registerUDO("oIBOQ", "Indirect BOQ", SAPbobsCOM.BoUDOObjType.boud_MasterData, findAliasNDescription, "B1_IBOQ");
                findAliasNDescription = null;

            }


            AddTable("B1_DBOQD", "Direct BOQ Detail", BoUTBTableType.bott_NoObject);
            AddColumns("@B1_DBOQD", "WBSStD", "Start Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@B1_DBOQD", "WBSED", "End Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@B1_DBOQD", "WBSLevel", "WBS Level", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_DBOQD", "WBSDscr", "WBS Description", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_DBOQD", "Type", "Line Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_DBOQD", "rCode", "Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_DBOQD", "rName", "Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_DBOQD", "Qty", "Quantity", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Sum);
            AddColumns("@B1_DBOQD", "Price", "Price", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Sum);
            AddColumns("@B1_DBOQD", "BgtCost", "Budgeted Cost", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Sum);
            AddColumns("@B1_DBOQD", "Remarks", "Remarks", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_DBOQD", "ItemCode", "Item Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@B1_DBOQD", "BOQType", "BOQ type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None);
           

            AddColumns("OITM", "B1_BOQREM", "BOQ Direct Remarks", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("OITM", "B1_BOQQty", "BOQ Qty", SAPbobsCOM.BoFieldTypes.db_Float, 8, SAPbobsCOM.BoFldSubTypes.st_Quantity);
            AddColumns("OITM", "LstUpdate", "Last Updated", SAPbobsCOM.BoFieldTypes.db_Date);


            AddColumns("JDT1", "B1_APP", "Allocation Percent", SAPbobsCOM.BoFieldTypes.db_Float,0,BoFldSubTypes.st_Sum);
          


            //** for Property Management Integration
            AddTable("ACPM_INT_BP", "Property Management BP", BoUTBTableType.bott_NoObject);
            AddColumns("@ACPM_INT_BP", "BPGroup", "Group", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@ACPM_INT_BP", "BillingAddress", "Billing Address", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@ACPM_INT_BP", "Email", "Email", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@ACPM_INT_BP", "Phone", "Phone", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@ACPM_INT_BP", "PostedSAP", "Posted to SAP", SAPbobsCOM.BoFieldTypes.db_Alpha, 1,SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@ACPM_INT_BP", "PostedDt", "Posted Date", SAPbobsCOM.BoFieldTypes.db_Date);
            AddColumns("@ACPM_INT_BP", "SAPCode", "SAP Card Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
            ...
            AddTable("AC_SYS_OBJ", "Object Types", BoUTBTableType.bott_NoObject);
            AddColumns("@AC_SYS_OBJ", "SboObj", "SAP Object", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_OBJ", "Keys", "Key Fields", SAPbobsCOM.BoFieldTypes.db_Alpha, 200, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_OBJ", "LogTable", "Log Table", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_OBJ", "LogActive", "Active for LOG", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_OBJ", "isDocument", "IsDocument", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None);


            AddTable("AC_SYS_DOCLOG", "Doc Log", BoUTBTableType.bott_NoObject);
            AddColumns("@AC_SYS_DOCLOG", "TBL", "Table", SAPbobsCOM.BoFieldTypes.db_Alpha, 10, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "ObjType", "Object Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 10, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "LogInstanc", "Log Instance", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "UserSign", "User", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "CreateDate", "Create Date", SAPbobsCOM.BoFieldTypes.db_Date, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "UpdateDate", "Update Date", SAPbobsCOM.BoFieldTypes.db_Date, 30, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "CreateTS", "Create Time", SAPbobsCOM.BoFieldTypes.db_Alpha, 10, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "UpdateTS", "Update Time", SAPbobsCOM.BoFieldTypes.db_Alpha, 10, SAPbobsCOM.BoFldSubTypes.st_None);
            AddColumns("@AC_SYS_DOCLOG", "DocEntry", "Doc Entry", SAPbobsCOM.BoFieldTypes.db_Numeric, 8, SAPbobsCOM.BoFldSubTypes.st_None);


            AddTable("ACPM_INT_USR", "Property Management INT User", BoUTBTableType.bott_NoObject);
            AddColumns("@ACPM_INT_USR", "APIKey", "Integration API Key", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, SAPbobsCOM.BoFldSubTypes.st_None);
        ...
        private void loadMenu(string lang)
        {
            ...
            mnus.Item("B1_CA").SubMenus.Add("mnu_AM", "Allocation Master", BoMenuType.mt_STRING, 2);
            mnus.Item("B1_CA").SubMenus.Add("mnu_AR", "Allocation Rules", BoMenuType.mt_STRING, 2);
            mnus.Item("B1_CA").SubMenus.Add("mnu_DBOQ", "BOQ - Direct", BoMenuType.mt_STRING, 2);

            mnus.Item("B1_CA").SubMenus.Add("mnu_IBOQ", "BOQ - Indirect", BoMenuType.mt_STRING, 2);
        ...
        public long getMaxId(string tblName, string idCol)
        {
            ...
            hp.Add("~p1", tblName);
            hp.Add("~p2", idCol);
            string strSql = getQryString("SYS_GET_MX",hp) ; // Select isnull(max(convert(int,~p2)),0)  as nextId from ~p1" ;
            try
            {
