...
#End If
        ...
        Protected Sub CallAddOnInstallAPI(ByVal addOnPath As String)
            ...
            If ret <> 0 Then
                MessageBox.Show("SetAddOnFolder(" + addOnPath + ") returned " + ret.ToString(),
            ...
            If installInfo.RestartNeeded Then
                ...
                If ret <> 0 Then
                    MessageBox.Show("RestartNeeded() returned " + ret.ToString(),
                                    "Error while trying to install the AddOn",
                                    MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                End If
            End If
...
#If Version = "2005" Then
            ...
            If ((installInfo.RestartNeeded And ret <> -1) Or
                (Not installInfo.RestartNeeded And ret <> 0)) Then
                MessageBox.Show("EndInstallEx returned " + ret.ToString(),
                                "Error while trying to install the AddOn",
                                MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
#Else
...
#End If
        ...
        End Sub
        '/// <summary>
        '/// Saves the addOn location path and AddOnInstallAPI_x64dll path into registry values.
        ...
        '/// <param name="dllPath">Path where the AddOnInstallAPI_x64dll is located</param>
        ...
        '/// <summary>
        '/// Reads the addOn location path and AddOnInstallAPI_x64dll path from registry values.
        ...
        '/// <summary>
        '/// Removes the addOn location path and AddOnInstallAPI_x64dll path from the registry values.
        '/// </summary>
