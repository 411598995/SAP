...
namespace ACHR
{
    ...
    public class UDClass
    {
        ...
        public void loadMenu(string lang)
        {
            ...
            mnus.Item("43523").SubMenus.Add("B1_ADV", "Ayyeka Advance", BoMenuType.mt_POPUP, 12);
            ...
            try
            {
                ...
                if (DemModules.ContainsKey("ABCommerce"))
                {
                    if (DemModules["ABCommerce"].ToString() == "Y")
                    {
                        ...
                        mnus.Item("B1_ABC").SubMenus.Add("mnu_WO", "Recieve Invoices from LTD", BoMenuType.mt_STRING, 3);

                        mnus.Item("B1_ABC").SubMenus.Add("mnu_WAR", "Create LTD Invoices for Customer", BoMenuType.mt_STRING, 3);
        ...
        public void createConfigurationTablesABCommerce()
        {
            ...
            AddColumns("ORDR", "B1_INT_DELIVERED", "Delivered to INC", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None, "");
            AddColumns("ORDR", "B1_INT_COMPLETED", "Invoiced to Customer", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_None, "");
            AddColumns("ORDR", "B1_INT_LTDAR", "LTD INV #", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "");
            AddColumns("ORDR", "B1_INT_INCAP", "INC APINV #", SAPbobsCOM.BoFieldTypes.db_Alpha, 30, SAPbobsCOM.BoFldSubTypes.st_None, "");
