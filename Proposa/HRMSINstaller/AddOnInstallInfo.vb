...
Namespace AddOnInstaller
    ...
    Public Class AddOnInstallInfo
        ...
        Public Sub New()
            MyBase.New
            'INITIALIZATION CODE	...
            AddOnName = "Order Entry"
            PartnerName = "Viatec"
            RestartNeeded = False
            ExeFile = "eOrderEntry.exe"
            DIFile = "Interop.SAPbobsCOM.dll"
            UIFile = "Interop.SAPbouiCOM.dll"
            B1WizardBaseFile = "Interop.MSXML2.dll"
            ExtraFiles = New String() {"CFL.bmp", "Payroll.bmp", "mfmLicensing.dll", "log4net.dll", "NCrontab.dll", "NLog.dll", "SapBusinessOneExtensions.dll"}
