...
namespace SapBusinessOneExtensions
{
    public sealed class SboProgressBar : IDisposable
    {
        ...
        private SboProgressBar(string text, int maxValue, Form relativeTo = null)
        {
        ...
        public static SboProgressBar Create(string text, int maxValue, Form relativeTo = null)
        {
            return new SboProgressBar(text, maxValue, relativeTo);
        }
