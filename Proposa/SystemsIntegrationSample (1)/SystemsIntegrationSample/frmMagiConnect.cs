...
namespace SystemsIntegrationSample
{
 ...
 Guid OrderStatus_Canceled = new Guid(System.Configuration.ConfigurationManager.AppSettings["MagiConnectOrderStatus_Cancelled"]);
            ...
            string Results = SalesWebService.UpdateOrderStatus(Login, Password,
                OrderID, OrderStatus_NewOrder, OrderStatus_Canceled, OrderTrackingReference, OrderStatusMessage);
