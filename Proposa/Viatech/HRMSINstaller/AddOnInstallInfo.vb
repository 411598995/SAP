...
Namespace AddOnInstaller
    ...
    Public Class AddOnInstallInfo
        ...
        Public Sub New()
            ...
            ExtraFiles = New String() {"DIHRMS.dll", "Msgs.res", "CFL.bmp", "Payroll.bmp", "mfmLicensing.dll", "ProductionLine.rpt", "ABCommerce.dll", "ViaTech.exe.config"}
