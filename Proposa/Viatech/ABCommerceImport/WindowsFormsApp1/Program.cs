    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                try
                {
                    MessageBox.Show("getting orders");
                   // getOrders();
                    changetonewOrders();
        ...
        public static void getOrders()
        {
            ...
            MagiConnect_Sales.salesSoapClient SalesWebService = new MagiConnect_Sales.salesSoapClient();
            //  SalesWebService.Close();
